    ...
    return (
        <div className="footer__whoAmI">
            ...
            <p>
                ...
                community which place that I learn and improve my skills. Among
                my future plans, I would like to create a community, just like
            ...
            <p>
                I am really loving to develop and build new things. From the
                moment I met React, I loved it. That being said, I build most of
                my projects with <Link href="https://reactjs.org/">React</Link>{" "}
            ...
            <p>
                ...
                projects and be the part of the{" "}
                <Link href="https://dev.to/">dev tech community</Link> very
                much!
            </p>
            <p>
